...
public class PaintView extends View
{
    ...
    private void initialize()
    {
        ...
        myPaint.setColor(myResources.getColor(R.color.purple_dark, null));
        ...
        myPath = new Path();
        route = new Vector<pointT>();
        count = sampleInterval; //make sure we always sample once at first touch
